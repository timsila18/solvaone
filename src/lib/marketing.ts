...
export const productPages: ProductPage[] = [
  {
    ...
    benefits: ["3-page depth target", "ATS-friendly structure", "Achievement-led wording", "Role-aligned skills"],
    receives: ["Detailed professional summary", "Expanded work experience", "Skills and keywords", "Editable PDF and Word document"],
    preview: "A substantial one-column CV with strong headings, measurable impact, rich sections, and no unnecessary graphics.",
  ...
  },
  {
    ...
    benefits: ["3-page depth target", "Stronger professional summary", "Improved bullet points", "ATS keyword suggestions"],
    receives: ["Detailed revamped CV", "Improvement summary", "Keyword suggestions", "Missing information recommendations"],
    preview: "A richer CV rebuilt from existing content, with clutter removed, achievements elevated, and weak areas clearly marked.",
